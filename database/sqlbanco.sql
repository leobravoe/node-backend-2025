...
START TRANSACTION;
USE `fornatto_db_2`;
INSERT INTO `fornatto_db_2`.`Produto` (`id`, `numero`, `nome`, `preco`, `TipoProduto_id`, `ingredientes`, `urlImagem`, `dataAtualizacao`, `dataCriacao`) VALUES (1, 1, 'Pepperoni', 50.50, 1, 'Pepperoni fatiado, queijo, cebola, pimentão, molho de tomate e orégano', NULL, '2023-02-28 19:00:00', '2023-02-28 19:00:00');
INSERT INTO `fornatto_db_2`.`Produto` (`id`, `numero`, `nome`, `preco`, `TipoProduto_id`, `ingredientes`, `urlImagem`, `dataAtualizacao`, `dataCriacao`) VALUES (2, 2, 'Laranja', 8.00, 2, 'Laranja, água e açucar', NULL, '2023-02-28 19:00:00', '2023-02-28 19:00:00');
INSERT INTO `fornatto_db_2`.`Produto` (`id`, `numero`, `nome`, `preco`, `TipoProduto_id`, `ingredientes`, `urlImagem`, `dataAtualizacao`, `dataCriacao`) VALUES (3, 3, 'Skol - Lata', 8.00, 3, 'Água, malte, milho e lúpulo. Alergênicos: Contém cevada e glúten', NULL, '2023-02-28 19:00:00', '2023-02-28 19:00:00');
